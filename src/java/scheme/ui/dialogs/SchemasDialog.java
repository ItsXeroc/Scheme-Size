...
public class SchemasDialog extends SchematicsDialog {
    ...
    @Override
    public Dialog show() {
        return super.show(); // do not show SchematicsDialog if the keybind combination is pressed
    }
        ...
        public ImportDialog() {
            ...
            cont.pane(pane -> {
                ...
                pane.table(Tex.button, t -> {
                    ...
                    button(t, "importfile", Icon.download, () -> GameCompat.openFile(schematicExtension, file -> {
                        try {
                    ...
                    button(t, "importimage", Icon.image, () -> {
                        GameCompat.openFile("png", file -> parser.show(file));
                    }).row();
